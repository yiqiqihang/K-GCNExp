...
if __name__ == '__main__':
    ...
    processors['demo_skeleton_offline'] = import_class('processor.demo_skeleton_offline.DemoSkeletonOffline')
    processors['demo_skeleton_cam'] = import_class('processor.demo_skeleton_cam.DemoSkeletonCam')
    processors['skeleton_lrp'] = import_class('processor.skeleton_lrp.SkeletonLRP')
